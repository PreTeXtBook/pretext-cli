...
def test_xml_overlay():
    ...
    assert (
        ET.tostring(root, encoding=str)
        == '<root><a><b fuzz="mom" baz="dad">Value!<c>Child val</c></b></a></root>'
    )
    assert messages == [
        "NODE_ADDED with XML path a",
        "NODE_ADDED with XML path a.b",
        "ATTRIBUTE_ADDED 'mom' at XML path 'a.b'",
        "ATTRIBUTE_ADDED 'dad' at XML path 'a.b'",
        "TEXT_ADDED ''Value!'' at XML path 'a.b'",
        "NODE_ADDED with XML path a.b.c",
        "TEXT_ADDED ''Child val'' at XML path 'a.b.c'",
    ]
    ...
    assert (
        ET.tostring(root, encoding=str)
        == '<root><a><b xxx="zzz"/></a><c>Hi there</c></root>'
    )
    ...
    assert (
        ET.tostring(root, encoding=str)
        == '<root><a><b xxx="zzz"/></a><a><b xxx="zzz"/></a></root>'
    )
